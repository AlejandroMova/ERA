...
import img3 from '../images/products3.jpg'; 
    ...
    return (
        <div className="background">
            ...
            <div className="images">
                <img className="images__image" src={img1} alt="Imágen Productos" />
                <img className="images__image" src={img2} alt="Imágen Productos" />
